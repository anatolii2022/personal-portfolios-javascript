...
const eingabeformular = {
  htm_fehlerbox_generieren(formular_fehler) {
  ...
  fehlerbox_anzeigen(formular_fehler) {
    ...
    if (eingabeformular_container !== null) {
      eingabeformular_container.insertAdjacentElement(
        "afterbegin",
        this.htm_fehlerbox_generieren(formular_fehler)
      );
    }
  },
  ...
  anzeigen() {
    ...
    if (navigationleiste !== null) {
      navigationleiste.insertAdjacentElement(
        "afterend",
  ...
  formulardaten_valiederen(formulardaten) {
    let fehler = [];
  ...
  absenden_event_hinzufuegen(eingabeformular) {
    eingabeformular
      ...
      .addEventListener("submit", (e) => {
        ...
        let formular_fehler = this.formulardaten_valiederen(formulardaten);
